...
доступны в [документации][writing-perf-tests] к OpenCV.
  ...
  1. Далее можно ознакомиться с заготовками еще двух тестов, которые имеются в
   ...
   1. Затем снова соберите несколько отчетов о производительности. Снова
      сравните колебания метрик с теми, что мы наблюдали при запуске
      демо-приложения, и проанализируйте их устойчивость.

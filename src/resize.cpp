...
//	const int src_cols_1 = src_cols-1;
    ...
    for (int row = 0; row < dst_rows; row++)
    {
        ...
        for (int col = 0; col < dst_cols; col++)
        {
            ...
            int temp = (x1 == x2) ? (int)(q11 * (y2 - y) + q22 * (y - y1)) :
